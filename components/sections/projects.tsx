...
const projects = [
  ...
  {
    title: "BookBasket",
    description: "Full-stack e-commerce platform with authentication, CRUD operations, and optimized performance.",
  ...
  {
    title: "V Tech Solutions Website",
    description: "Production-ready React website built from scratch for real client requirements and usability constraints.",
