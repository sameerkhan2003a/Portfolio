  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 xl:px-10">
        ...
        <div className="grid gap-12 md:grid-cols-2 md:gap-12 lg:gap-20">
          {/* Left */}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {openTo.map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-border bg-card px-3 py-2 text-xs text-foreground transition-colors hover:border-primary/40 hover:bg-primary/5 sm:px-4 sm:text-sm"
                  >
                    {item}
                  </span>
                ))}
          ...
          <div className="space-y-4">
            {contactLinks.map((link) => (
              <a
                ...
                className="group flex items-center gap-4 rounded-2xl border border-border bg-card p-4 transition-all duration-300 hover:-translate-y-1 hover:border-primary/40"
              >
                ...
                <ArrowUpRight className="h-5 w-5 flex-shrink-0 text-muted-foreground transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-primary" />
              </a>
            ))}
          </div>
        </div>
